        ...
        return """
                ...
                <head>
                    ...
                    <style>
                        ...
                        body {
                            max-width: 900px; margin: 0 auto; padding: 32px 42px 64px;
                            background: #1e1f22; color: #dfe1e5;
                            font: 15px/1.65 Inter, "Segoe UI", sans-serif;
                        }
                        ...
                        code { background: #2b2d30; color: #e6b673; padding: .15em .35em; border-radius: 4px; }
                        pre { overflow-x: auto; background: #25262a; border: 1px solid #393b40;
